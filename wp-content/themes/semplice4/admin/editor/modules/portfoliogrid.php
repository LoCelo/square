	...
	class sm_portfoliogrid {
		...
		public function output_editor($values, $id) {
			...
			if(!empty($projects)) {
				...
				// get masonry
				$this->output['html'] = $filter_output . semplice_masonry('portfoliogrid', $id, $values['options'], $masonry_items, $hor_gutter, $ver_gutter, $this->is_editor, $values['script_execution']);
			} else {
